...
CIDADES = [
    ...
    },
    {
        ...
        "alertas": [
            ...
            {"nivel": 2.00, "descricao": "ATENÇÃO"},
            {"nivel": 1.07, "descricao": "ATENÇÃO (ESTIAGEM)"},
            {"nivel": 1.00, "descricao": "ALERTA (ESTIAGEM)"},
            {"nivel": 0.92, "descricao": "ESCASSEZ HÍDRICA"},
        ],
        "nome": "Porto Amazonas",
        "uf": "PR",
        "codigo_ana": 65035001,
        ...
        "niveis_fonte": {
            "tipo": "plancon",
            "orgao": "Defesa Civil de Porto Amazonas (COMPDEC)",
            "documento": "Plano de Contingência Municipal de Proteção e Defesa Civil - versão 22",
            "data": "02/07/2026",
            "url": "https://www.portoamazonas.pr.gov.br/wp-content/uploads/Conteudo/DEFESA%20CIVIL/PLACOM.pdf",
            "niveis": [
                {"nome": "Atenção", "nivel": 2.00,
                 "texto": "Primeiro patamar do plano municipal para o Rio Iguaçu. Atingi-lo é um dos critérios para o município considerar a ativação do Plano de Contingência e intensificar o monitoramento do rio e das áreas mapeadas."},
                {"nome": "Alerta", "nivel": 4.00,
                 "texto": "Patamar de alerta do plano municipal. A partir dele o plano orienta a resposta nas áreas de atenção cadastradas: a porção baixa do Centro, próxima ao rio (cais e biquinha), com 96 residências e 285 pessoas afetáveis segundo o próprio plano."},
                {"nome": "Enchente", "nivel": 5.00, "complemento": True,
                 "texto": "Nível em que, segundo a Defesa Civil de Porto Amazonas, a água começa a atingir residências nas áreas monitoradas (comunicado de 10/09/2026). Desde 1935, o rio esteve acima de 5,00 m em apenas 0,6% dos dias medidos na estação."},
                {"nome": "Grande enchente", "nivel": 6.00, "proprio": True,
                 "texto": "Referência histórica deste site, não da Defesa Civil: acima de 6,00 m estão só as maiores cheias já registradas em Porto Amazonas — 1983 (9,13 m), 1995 (7,82 m), 1992 (7,44 m), 1935 (6,82 m), 1971 (6,61 m), 2010 (6,47 m), 1998 (6,44 m), 2023 (6,24 m), 1987 (6,20 m), 1957 (6,19 m), 2013 (6,08 m) e 1993 (6,07 m). Desde 1935 o rio passou desse nível em 12 episódios, 0,15% dos dias medidos."},

            ],
            "complemento": {
                "texto": "comunicado oficial da Defesa Civil de Porto Amazonas de 10/09/2026, publicado pela prefeitura",
                "url": "https://www.portoamazonas.pr.gov.br/noticias_destaque/%e2%9a%a0%ef%b8%8f-alerta-alto-possivel-inundacao/",
            },
            "estiagem": [
                {"nome": "Atenção (Estiagem)", "nivel": 1.07},
                {"nome": "Alerta (Estiagem)", "nivel": 1.00},
                {"nome": "Escassez hídrica", "nivel": 0.92},
            ],
        },
        "historico_serie": {
            "periodo": "1936–2025",
            "anos": 90,
            "limiar_m": 6.00,
            "fonte": "ANA/HidroWeb (estação 65035000, série 1935–2020, dados consistidos quando disponíveis) e estação telemétrica 65035001",
            "pico_por_mes": [
                {"mes": "Janeiro", "anos": 14},
                {"mes": "Fevereiro", "anos": 11},
                {"mes": "Junho", "anos": 11},
                {"mes": "Maio", "anos": 10},
                {"mes": "Setembro", "anos": 8},
                {"mes": "Novembro", "anos": 8},
            ...
            "episodios": [
                {"inicio": "1935-10-03", "fim": "1935-10-08", "dias": 6, "pico_m": 6.82, "data_pico": "1935-10-03"},
                {"inicio": "1957-08-01", "fim": "1957-08-01", "dias": 1, "pico_m": 6.19, "data_pico": "1957-08-01"},
                {"inicio": "1970-12-31", "fim": "1971-01-11", "dias": 12, "pico_m": 6.61, "data_pico": "1971-01-09"},
                {"inicio": "1983-07-08", "fim": "1983-07-17", "dias": 10, "pico_m": 9.13, "data_pico": "1983-07-11"},
                {"inicio": "1987-05-21", "fim": "1987-05-21", "dias": 1, "pico_m": 6.20, "data_pico": "1987-05-21"},
                {"inicio": "1992-05-31", "fim": "1992-06-02", "dias": 3, "pico_m": 7.44, "data_pico": "1992-05-31"},
                {"inicio": "1993-10-05", "fim": "1993-10-05", "dias": 1, "pico_m": 6.07, "data_pico": "1993-10-05"},
                {"inicio": "1995-01-11", "fim": "1995-01-19", "dias": 9, "pico_m": 7.82, "data_pico": "1995-01-14"},
                {"inicio": "1998-09-29", "fim": "1998-10-05", "dias": 7, "pico_m": 6.44, "data_pico": "1998-09-29"},
                {"inicio": "2010-04-27", "fim": "2010-04-29", "dias": 3, "pico_m": 6.47, "data_pico": "2010-04-28"},
                {"inicio": "2013-06-25", "fim": "2013-06-25", "dias": 1, "pico_m": 6.08, "data_pico": "2013-06-25"},
                {"inicio": "2023-10-31", "fim": "2023-11-04", "dias": 5, "pico_m": 6.24, "data_pico": "2023-11-04"},
            ],
        },
        "enchentes": [
            {"nivel": 9.13, "descricao": "Enchente de 1983"},
            {"nivel": 7.82, "descricao": "Enchente de 1995"},
            {"nivel": 7.44, "descricao": "Enchente de 1992"},
            {"nivel": 6.82, "descricao": "Enchente de 1935"},
            {"nivel": 6.61, "descricao": "Enchente de 1971"},
            {"nivel": 6.47, "descricao": "Enchente de 2010"},
            {"nivel": 0.76, "descricao": "Menor nível histórico - estiagem de 1978"},
        ],
    },
    {
...
def montar_payload(cidade, historico, semana, motivo_chuva=None):
    ...
    return {
        ...
        "fonte": FONTE_ANA,
        "fonte_alertas": (cidade.get("niveis_fonte") or {}).get("orgao") or (FONTE_ALERTAS if cidade.get("alertas") else None),
        ...
        "historico_serie": cidade.get("historico_serie"),
        "previsao": [],
